	    ...
	    <div class="filterbox">
			...
			<div class="filter_td">
				...
				<ul class="filter_sel filter_drop" data-filter="year" id="gradeUl">
					<li class="sel">
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=0&course=<%=request.getAttribute("course") %>">全部</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=1&course=<%=request.getAttribute("course") %>">一年级</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=2&course=<%=request.getAttribute("course") %>">二年级</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=3&course=<%=request.getAttribute("course") %>">三年级</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=4&course=<%=request.getAttribute("course") %>">四年级</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=5&course=<%=request.getAttribute("course") %>">五年级</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=6&course=<%=request.getAttribute("course") %>">六年级</a>
					</li>
				...
				<ul class="filter_sel filter_drop" data-filter="class" id="courseUl">
					...
					<li class="sel">
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=<%=request.getAttribute("grade") %>&course=0">全部</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=<%=request.getAttribute("grade") %>&course=1">语文</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=<%=request.getAttribute("grade") %>&course=2">数学</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=1&grade=<%=request.getAttribute("grade") %>&course=3">英语</a>
					</li>
				</ul>
			</div>
		</div>
...
$(function(){
	...
	$("#gradeUl li").eq(<%=request.getAttribute("grade")%>).addClass("sel");
