...
<html>
  <head>
    ...
    <meta name="description" content="吉师家教网是中国领先的家教门户网站，服务覆盖全国，已为10多万学员提供上百种科目的数十万兼职大学生家教、专职教师和专业人士。上门授课，免费试教。150-6033-8989">
	    ...
	    <div class="filterbox">
			...
			<div class="filter_td">
				...
				<ul class="filter_sel filter_drop" data-filter="year" id="gradeUl">
					...
					<li class="sel">
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=0&course=<%=request.getAttribute("course") %>">全部</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=7&course=<%=request.getAttribute("course") %>">初一</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=8&course=<%=request.getAttribute("course") %>">初二</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=9&course=<%=request.getAttribute("course") %>">初三</a>
					</li>
				</ul>
				<ul class="filter_sel filter_drop" data-filter="class" id="courseUl">
					<li class="sel">
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=0">全部</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=1">语文</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=2">数学</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=3">英语</a>
					</li>
					
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=4">物理</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=5">生物</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=6">化学</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=7">政治</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=8">历史</a>
					</li>
					<li>
						<a
							href="<%=basePath %>paper/mPaperList.action?degree=2&grade=<%=request.getAttribute("grade") %>&course=9">地理</a>
					</li>
				</ul>
			</div>
		</div>
...
$(function(){
	...
	if(<%=request.getAttribute("grade")%>!=0){
		$("#gradeUl li").eq(<%=request.getAttribute("grade")%>-6).addClass("sel");
	}else{
