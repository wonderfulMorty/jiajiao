    ...
    <div class="clearfix w_1200 d_link">
        <div class="d_link_t clearfix">
            <div class="d_link_tel fl">
                <h4>服务热线</h4>
                <p>(工作日9:00~18:00)</p>
                <div class="d orange_text big_num font_34">150-6033-8989</div>
            </div>
            <div class="r_cell">
...
<!--end链接-->
    ...
    <!--返回顶部-->
    <div class="ftool_top"><a href="javascript:void(0);" class="top_ftoolab transition_a" id="ftoolTop" style="display: block;"></a></div>
    <!--返回顶部-->
