...
<input type="hidden" id="lastLoginTime" name="teacherId" value="<%=teacher.getLastLoginTime() %>" >
<input type="hidden" id="isCheck" name="teacherId" value="<%=teacher.getIsCheck() %>" >
<input type="hidden" id="personImg" name="teacherId" value="<%=teacher.getPersonImg() %>" >
		                ...
		                <td>
		                    <div class="">
								...
								<tr>
					                <th>薪酬要求</th>
					                <td>
					                    <input type="text" class="fill_text" id="coursePrice" name="coursePrice"  placeholder="若执行吉师家教网薪酬标准,请填写 ‘0’ " value="<%=teacher.getCoursePrice() %>">&nbsp;&nbsp;&nbsp;&nbsp;元/小时
					                </td>
					            </tr>
					            <tr>
					                <th>辅导方式</th>
...
<div class="cd-popup" id="SubjectModal">
    <div class="cd-popup-container cd-popup-container_h" style="width:1200px;">
        <a href="http://fz.ygjj.com/resume/guide2#0" class="cd-popup-close f_close_btn transition_a"></a>
        <h4 class="f_code_th">求教科目<p>求教科目最多可以选择10个</p></h4>
...
<script>
    ...
    $("#btnSave").click(function () {
        ...
        data.lastLoginTime = $("#lastLoginTime").val();
        data.isCheck = $("#isCheck").val();
        data.personImg = $("#personImg").val();
        ...
        $.post("admin/updateInfo.action", data, function (res) {
            if (res.success) {
            	alert(res.message);
