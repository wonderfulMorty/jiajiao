	    ...
	    <div class="filterbox">
			...
			<div class="filter_td">
				<ul class="filter_sel filter_drop" data-filter="grade" id="degreeUl">
					<li class="sel">
						<a
							href="<%=basePath %>news/mNewsList.action?degree=1">小学</a>
					</li>
					<li >
						<a
							href="<%=basePath %>news/mNewsList.action?degree=2">初中</a>
					</li>
					<li >
						<a
							href="<%=basePath %>news/mNewsList.action?degree=3">高中</a>
					</li>
				</ul>
			</div>
		</div>
...
$(function(){
	...
	$("#degreeUl li").eq(<%=request.getAttribute("degree")%>-1).addClass("sel");
...

{
    ...
    $.ajax({
        url : "<%=basePath%>news/mNewsListQuery.action",
            ...
            if(data==null){
                ...
                if(type=="00"){
                    ...
                    for(var i=0;i<data.length;i++){
                      content=content
                            +   '<li>'
                            +   '<a href="mNewsInfo.action?nId='+data[i].nId+'">'
